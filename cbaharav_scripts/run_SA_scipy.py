...
Usage:
    python run_SA_scipy.py --instance instance_name_size 
    python run_SA_scipy.py --instance instance_name_size --num_draws 100

NOTES:
    - see notes for run_SA.py
    - default output: output_file = f'intermediate_data/dropped_0/{instance}/SA_panels_output_scipy.csv'
...
def main():
    ...
    output_file = f'intermediate_data/dropped_0/{instance}/SA_panels_output_scipy.csv'
    # output_file = f'intermediate_data/dropped_0/{instance}/SA_panels_output_scipytime.csv'
    # output_file = f'intermediate_data/dropped_0/{instance}/SA_panels_output_scipysmall.csv'
