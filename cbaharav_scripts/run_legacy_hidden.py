"""
Run the Legacy algorithm with hidden categories.
For each category (and category pair), hide the category from constraints
and run legacy, saving results to separate folders.

Usage:
    python run_legacy_hidden.py --instance instance_name_size
    python run_legacy_hidden.py --instance instance_name_size --num_draws 100
"""
...
def run_draws(instance, num_draws, hidden_categories):
    """
    Run legacy with specified hidden categories.
