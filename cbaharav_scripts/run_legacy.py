"""
Run the Legacy algorithm to select panels.
Calling this implementation of legacy https://github.com/sortitionfoundation/sortition-algorithms/tree/main
...
Usage:
    python run_legacy.py --instance instance_name_size
    python run_legacy.py --instance instance_name_size --num_draws 100
"""
...
def run_draws(instance, num_draws):
    ...
    output_file      = f'intermediate_data/dropped_0/{instance}/legacy_panels_output.csv'
    ...
    console_print(f'Starting {num_draws} draws with algorithm: legacy')
